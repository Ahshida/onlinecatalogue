...
class Toolsinfo(models.Model):
    ...
    din = models.IntegerField(db_column='DIN', blank=True, null=True)  # Field name made lowercase.
    ...
    availablein = models.TextField(db_column='AvailableIn', blank=True, null=True)  # Field name made lowercase.
...
class TipsonappComuser(models.Model):
